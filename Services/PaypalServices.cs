...
namespace PhuKienDienThoai.Services
{
    public class PaypalServices : IPaypalServices
    {
        ...
        private APIContext apiContext = new APIContext(new OAuthTokenCredential("AWPCbUS94ozBClf7KBzGwiBLm0v17pdFL0TKjDuBMa_bvemHAEMJSebWFVRcvfGUlufGbTWLnaAmAUUe", "EHGtbnZI9beZ-69ak1jY-W6xxjKvs6ywLGPug_Ic6LN-SONYlOcwibI-zmB6QUthKieSpLvH6NCgjZhN").GetAccessToken());
